...
const CardFour = ({ photo, fName, lName, gender, contact }) => {
    return (
        <div className='h-20 w-[250px] relative z-0 group cursor-pointer'>
            <div className='h-full w-full rounded-full bg-purple-500 flex justify-between space-x-5 overflow-clip z-[300] hover:border-4 hover:border-purple-500 duration-100 delay-100'>
